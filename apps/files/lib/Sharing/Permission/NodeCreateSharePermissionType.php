...
final class NodeCreateSharePermissionType implements ISharePermissionType {
	...
	public function getDisplayName(): string {
		return Server::get(IFactory::class)->get(Application::APP_ID)->t('Create files');
	}
	...
	public function getDefault(): bool {
		return (Server::get(IAppConfig::class)->getValueInt(Application::APP_ID, 'shareapi_default_permissions') & Constants::PERMISSION_CREATE) === Constants::PERMISSION_CREATE;
	}
}
