...
window.addEventListener('DOMContentLoaded', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('form').submit(function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.strengthify-wrapper, .tipsy').css('filter', 'alpha(opacity=30)').css('opacity', 0.3); // Create the form
...
/******/ })()
;
//# sourceMappingURL=core-install.js.map?v=6204b28b70851f388174