...
const Dialogs = {
  ...
  filepicker(title, callback) {
    ...
    if (type === this.FILEPICKER_TYPE_CUSTOM) {
      ...
      builder.setButtonFactory((nodes, path) => {
        ...
        const target = node || (0,path__WEBPACK_IMPORTED_MODULE_6__.basename)(path);
        if (type === _nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_5__.FilePickerType.Choose) {
          buttons.push({
            ...
            label: node && !this.multiSelect ? t('core', 'Choose {file}', {
              file: node
            }) : t('core', 'Choose'),
            type: 'primary'
          });
        ...
        if (type === _nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_5__.FilePickerType.CopyMove || type === _nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_5__.FilePickerType.Copy) {
          buttons.push({
            ...
            label: target ? t('core', 'Copy to {target}', {
              target
            }) : t('core', 'Copy'),
            type: 'primary',
        ...
        if (type === _nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_5__.FilePickerType.Move || type === _nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_5__.FilePickerType.CopyMove) {
          buttons.push({
            ...
            label: target ? t('core', 'Move to {target}', {
              target
            }) : t('core', 'Move'),
  ...
  _getMessageTemplate: function () {
    ...
    if (!this.$messageTemplate) {
      var self = this;
      jquery__WEBPACK_IMPORTED_MODULE_1___default().get(_index_js__WEBPACK_IMPORTED_MODULE_4__["default"].filePath('core', 'templates', 'message.html'), function (tmpl) {
...
/* harmony import */ var _nextcloud_router__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @nextcloud/router */ "./node_modules/@nextcloud/router/dist/index.js");
...
/* harmony export */ });
/* harmony import */ var _nextcloud_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nextcloud/router */ "./node_modules/@nextcloud/router/dist/index.js");
/* harmony import */ var _nextcloud_vue_dist_Components_NcPasswordField_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @nextcloud/vue/dist/Components/NcPasswordField.js */ "./node_modules/@nextcloud/vue/dist/Components/NcPasswordField.mjs");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    NcPasswordField: _nextcloud_vue_dist_Components_NcPasswordField_js__WEBPACK_IMPORTED_MODULE_1__["default"],
...
/******/ })()
;
//# sourceMappingURL=core-login.js.map?v=a612228ef99e240e3199