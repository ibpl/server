...
const picker = (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_3__.getFilePickerBuilder)(t('files', 'Choose a file or folder to transfer')).setMultiSelect(false).setType(1).allowDirectories().build();
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    start() {
      ...
      picker.pick().then(dir => dir === '' ? '/' : dir).then(dir => {
        _logger_js__WEBPACK_IMPORTED_MODULE_6__["default"].debug(`path ${dir} selected for transferring ownership`);
        if (!dir.startsWith('/')) {
        ...
        _logger_js__WEBPACK_IMPORTED_MODULE_6__["default"].error(`Selecting object for transfer aborted: ${error.message || 'Unknown error'}`, {
          error
        });
...
/******/ })()
;
//# sourceMappingURL=files-personal-settings.js.map?v=0a875bfa132c763188f0