...
/* harmony import */ var vue_material_design_icons_Star_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! vue-material-design-icons/Star.vue */ "./node_modules/vue-material-design-icons/Star.vue");
/* harmony import */ var vue_material_design_icons_StarOutline_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! vue-material-design-icons/StarOutline.vue */ "./node_modules/vue-material-design-icons/StarOutline.vue");
...
/* harmony import */ var _services_FileInfo_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../services/FileInfo.js */ "./apps/files/src/services/FileInfo.js");
/* harmony import */ var _components_LegacyView_vue__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../components/LegacyView.vue */ "./apps/files/src/components/LegacyView.vue");
/* harmony import */ var _components_SidebarTab_vue__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../components/SidebarTab.vue */ "./apps/files/src/components/SidebarTab.vue");
/* harmony import */ var _systemtags_src_components_SystemTags_vue__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../systemtags/src/components/SystemTags.vue */ "./apps/systemtags/src/components/SystemTags.vue");
/* provided dependency */ var console = __webpack_require__(/*! ./node_modules/console-browserify/index.js */ "./node_modules/console-browserify/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: 'Sidebar',
  components: {
    LegacyView: _components_LegacyView_vue__WEBPACK_IMPORTED_MODULE_15__["default"],
    ...
    SidebarTab: _components_SidebarTab_vue__WEBPACK_IMPORTED_MODULE_16__["default"],
    SystemTags: _systemtags_src_components_SystemTags_vue__WEBPACK_IMPORTED_MODULE_17__["default"],
    Star: vue_material_design_icons_Star_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
    StarOutline: vue_material_design_icons_StarOutline_vue__WEBPACK_IMPORTED_MODULE_10__["default"]
  },
  data() {
    return {
      // reactive state
  ...
  computed: {
    ...
    davPath() {
      ...
      return OC.linkToRemote(`dav/files/${user}${(0,_nextcloud_paths__WEBPACK_IMPORTED_MODULE_1__.encodePath)(this.file)}`);
    },
    /**
     ...
     */
    fullTime() {
      return _nextcloud_moment__WEBPACK_IMPORTED_MODULE_8___default()(this.fileInfo.mtime).format('LLL');
    },
    /**
    ...
    isSystemTagsEnabled() {
      return (0,_nextcloud_capabilities__WEBPACK_IMPORTED_MODULE_3__.getCapabilities)()?.systemtags?.enabled === true;
    }
  },
  created() {
  ...
  methods: {
    ...
    async toggleStarred(state) {
      try {
        ...
        await (0,_nextcloud_axios__WEBPACK_IMPORTED_MODULE_7__["default"])({
          method: 'PROPPATCH',
          url: this.davPath,
        ...
        const Node = isDir ? _nextcloud_files__WEBPACK_IMPORTED_MODULE_2__.Folder : _nextcloud_files__WEBPACK_IMPORTED_MODULE_2__.File;
        (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_0__.emit)(state ? 'files:favorites:added' : 'files:favorites:removed', new Node({
          ...
          source: this.davPath,
          root: `/files/${(0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_4__.getCurrentUser)().uid}`,
    ...
    onDefaultAction() {
      if (this.defaultAction) {
        ...
        this.defaultAction.action(this.fileInfo.name, {
          ...
          $file: jquery__WEBPACK_IMPORTED_MODULE_6___default()('body')
        });
      }
    },
    /**
    ...
    async open(path) {
      ...
      this.loading = true;
      try {
        this.fileInfo = await (0,_services_FileInfo_js__WEBPACK_IMPORTED_MODULE_14__["default"])(this.davPath);
    ...
    scopedSlots: _vm._u([_vm.fileInfo ? {
      ...
      fn: function () {
        return [_c("NcActionButton", {
          ...
          scopedSlots: _vm._u([_vm.fileInfo.isFavourited ? {
            key: "icon",
            fn: function () {
              return [_c("StarOutline", {
                attrs: {
                  size: 20
                }
              })];
...
/******/ })()
;
//# sourceMappingURL=files-sidebar.js.map?v=125b50cf29464383cbcd