    ...
    */
    ...
    updateEmptyContent: function updateEmptyContent() {
      ...
      if (dir === '/') {
        ...
        this.$el.find('.files-filestable thead th').toggleClass('hidden', this.isEmpty); // hide expiration date header for non link only shares
...
/******/ })()
;
//# sourceMappingURL=files_sharing-files_sharing.js.map?v=961065310e6a1ca4ebb1