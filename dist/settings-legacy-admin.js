...
window.addEventListener('DOMContentLoaded', function () {
  $('#excludedGroups,#linksExcludedGroups,#passwordsExcludedGroups').each(function (index, element) {
    ...
    $(element).change(function (ev) {
      ...
      OCP.AppConfig.setValue('core', $(_this2).attr('name'), groups);
    });
  });
  ...
  $('#shareAPIEnabled').change(function () {
    $('#shareAPI p:not(#enable)').toggleClass('hidden', !_this.checked);
  });
  ...
  $('#allowGroupSharing').change(function () {
    $('#allowGroupSharing').toggleClass('hidden', !_this.checked);
  });
  $('#shareapiExcludeGroups').change(function () {
    $('#selectExcludedGroups').toggleClass('hidden', !_this.checked);
  });
...
/******/ })()
;
//# sourceMappingURL=settings-legacy-admin.js.map?v=092d0bbbc2d131761085