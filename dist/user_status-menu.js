...
/* harmony import */ var _services_heartbeatService_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/heartbeatService.js */ "./apps/user_status/src/services/heartbeatService.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted() {
    ...
    if (OC.config.session_keepalive) {
      ...
      this.mouseMoveListener = debounce__WEBPACK_IMPORTED_MODULE_2___default()(() => {
  ...
  methods: {
    ...
    async _backgroundHeartbeat() {
      try {
        const status = await (0,_services_heartbeatService_js__WEBPACK_IMPORTED_MODULE_3__.sendHeartbeat)(this.isAway);
        if (status?.userId) {
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c(_vm.inline ? "div" : "li", {
    tag: "component"
  }, [!_vm.inline ? _c("button", {
  ...
  }, [_vm._v("\n\t\t" + _vm._s(_vm.visibleMessage) + "\n\t")]), _vm._v(" "), _vm.isModalOpen ? _c("SetStatusModal", {
    on: {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.user-status-menu-item[data-v-03512cb0] {
  width: auto;
  min-width: 44px;
  height: 44px;
  margin: 0;
...
.user-status-menu-item[data-v-03512cb0]:active, .user-status-menu-item[data-v-03512cb0]:hover, .user-status-menu-item[data-v-03512cb0]:focus-visible {
  background-color: var(--color-background-hover);
}
.user-status-menu-item[data-v-03512cb0]:focus-visible {
  box-shadow: 0 0 0 4px var(--color-main-background) !important;
  outline: 2px solid var(--color-main-text) !important;
}
.user-status-icon[data-v-03512cb0] {
  width: 16px;
  height: 16px;
  margin-right: 10px;
  opacity: 1 !important;
...
/******/ 			return "" + chunkId + "-" + chunkId + ".js?v=" + {"node_modules_nextcloud_dialogs_dist_chunks_index-27e9ea0a_mjs":"f098494fd65ef942c7b1","user-status-modal":"9c5be12a6a6810b25a12","data_image_svg_xml_base64_PCEtLSBUaGlzIGljb24gaXMgcGFydCBvZiBNYXRlcmlhbCBVSSBJY29ucy4gQ29weXJ-a6b278":"a48550cd83d7aad22499"}[chunkId] + "";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=user_status-menu.js.map?v=df7bfd85a7b721f529fa