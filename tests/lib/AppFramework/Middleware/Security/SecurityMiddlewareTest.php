...
class SecurityMiddlewareTest extends \Test\TestCase {
	...
	public static function dataPublicPageExAppRequired(): array {
		return [
			['testAnnotationPublicPageExAppRequired'],
			['testAttributePublicPageExAppRequired'],
		];
	}
	...
	/**
	 * @dataProvider dataPublicPageExAppRequired
	 */
